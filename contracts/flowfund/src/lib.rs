//! FlowFund — a minimal but complete crowdfunding contract for Stellar / Soroban.
//!
...
mod test {
    ...
    fn full_lifecycle_success() {
        ...
        let contract_id = env.register(Flowfund, ());
        let client = FlowfundClient::new(&env, &contract_id);
